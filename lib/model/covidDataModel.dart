...
CovidDataModel covidDataModelFromJson(String str) =>
    CovidDataModel.fromJson(json.decode(str));

String covidDataModelToJson(CovidDataModel data) => json.encode(data.toJson());
